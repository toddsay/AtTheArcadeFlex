...
class PanAndScanArt extends PreserveArt
{
    ...
    constructor(name, x, y, w, h, parent = ::fe)
    {
		...
		art.trigger = Transition.ToNewList;  //Add this line
    ...
    function update_panandscan()
    {
        if (!request_size)
        {
            ...
            {
                if (animate_type == ::AnimateType.HorizBounce || animate_type == ::AnimateType.Bounce || animate_type == ::AnimateType.HorizMove)
                {
